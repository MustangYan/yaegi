...
[![release](https://img.shields.io/github/tag-date/traefik/yaegi.svg?label=alpha)](https://github.com/MustangYan/yaegi/releases)
[![Build Status](https://github.com/MustangYan/yaegi/actions/workflows/main.yml/badge.svg)](https://github.com/MustangYan/yaegi/actions/workflows/main.yml)
[![GoDoc](https://godoc.org/github.com/MustangYan/yaegi?status.svg)](https://pkg.go.dev/mod/github.com/MustangYan/yaegi)
...
```go
import "github.com/MustangYan/yaegi/interp"
```

### Command-line executable

```bash
go get -u github.com/MustangYan/yaegi/cmd/yaegi
```
...
```console
$ yaegi -syscall -unsafe -unrestricted github.com/MustangYan/yaegi/cmd/yaegi
>
```
...
[docs]: https://pkg.go.dev/github.com/MustangYan/yaegi
[license]: https://github.com/MustangYan/yaegi/blob/master/LICENSE
[github]: https://github.com/MustangYan/yaegi
[bugs]: https://github.com/MustangYan/yaegi/issues?q=is%3Aissue+is%3Aopen+label%3Abug
